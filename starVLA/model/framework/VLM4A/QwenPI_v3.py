    ...
    def forward(
        ...
        **kwargs,
        ...
        with torch.autocast("cuda", dtype=torch.float32):
            ...
            action_loss_output = self.action_model(
        ...
        if isinstance(action_loss_output, dict):
            return {
                "action_loss": action_loss_output["loss"],
                "action_loss_per_dim": action_loss_output.get("loss_per_dim"),
            }

        return {"action_loss": action_loss_output}
