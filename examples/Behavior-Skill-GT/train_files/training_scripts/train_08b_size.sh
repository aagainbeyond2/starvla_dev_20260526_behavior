#!/usr/bin/env bash
# ============================================================================
# 写死配置的单机训练启动器 —— 【0.8B size_proportional(采样消融)】
# 直接 bash 本脚本即可, 无需任何参数(config 已写死, 避免传参被无视的坑)。
#   bash examples/Behavior-Skill-GT/train_files/training_scripts/train_08b_size.sh
...
# ============================================================================
CONFIG="examples/Behavior-Skill-GT/train_files/training_config/train_gt_behavior_skill_easy_qwen35_08b_size_proportional.yaml"
...
echo "[train_08b_size] repo   = ${REPO_ROOT}"
echo "[train_08b_size] config = ${CONFIG}"
echo "[train_08b_size] python = $(which python)"
echo "[train_08b_size] 起训中... 核对下面 single_nodes 打印的 CONFIG_YAML/output_dir 含 08b_size_proportional 再走开。"
